...
var data_base:Array[Dictionary] = [
	...
	{
		KEY_ACTOR : ACTOR_NONE,
		KEY_SPEECH : "Он приносит мне еду и энергетики, а заодно выносит мусор. Не знаю, что бы я делал без такого понимающего друга.",
	},
	{
		KEY_ACTOR : ACTOR_NONE,
	...
	{	
		KEY_ACTOR : ACTOR_NONE,
		KEY_SPEECH : " Я не помню, какой сейчас месяц и день недели,", 
	},
	{
		KEY_ACTOR : ACTOR_NONE,	
		KEY_SPEECH : "ведь каждый мой день – день сурка: ем, пью кофе – все за столом, все с радио и отцовскими дневниками.",
	},
	{
		KEY_ACTOR : ACTOR_NONE,
	...
	{
		KEY_ACTOR : ACTOR_NONE,
		KEY_SPEECH : "Не помню, если не считать те редкие лучи, проникающие в мою комнату сквозь занавески на окнах.",
	},
	{
		KEY_ACTOR : ACTOR_NONE,
	...
	{
		KEY_ACTOR : ACTOR_NONE,
		KEY_SPEECH : "Я купил себе азбуку Морзе,",
	},
	{
		KEY_ACTOR : ACTOR_NONE,
		KEY_SPEECH : "но доводы Жени о том, что это всего лишь шутка, были достаточно убедительны, чтобы я не стал декодировать это сам.",
	},
	{
		KEY_ACTOR : ACTOR_NONE,
	...
	{
		KEY_ACTOR : ACTOR_NONE,
		KEY_SPEECH : "Правда, мы так и не узнали, что именно, а Женя отказывается подключаться еще раз к тому источнику информации.",
	},
	{
		KEY_ACTOR : ACTOR_NONE,
		KEY_SPEECH : "Думаю, этот информатор сильно напугал его, иначе он бы сделал все, чтобы помочь мне.",
	},
	{
		KEY_ACTOR : ACTOR_NONE,
	...
	{
		KEY_ACTOR : ACTOR_NONE,
		KEY_SPEECH : "Если это случится, меня хотя бы не придется искать – я буду дома за радио.",
	},
	{
		KEY_ACTOR : ACTOR_FRIEND,
		KEY_SPEECH : "Может, он и пытался как-то намекнуть тебе, где нужно искать. Но тот сигнал был ошибкой.",
	},
	{
		KEY_ACTOR : ACTOR_FRIEND,
	...
	{
		KEY_ACTOR : ACTOR_FRIEND,
		KEY_SPEECH : "Может, цифры, буквы? Какой-то ключ, который натолкнет тебя на нужную зацепку?",
	},
	{
		KEY_ACTOR : ACTOR_FRIEND, 
		KEY_SPEECH : "Я думаю, что это где-то здесь. Возможно, мы пока не видим, не замечаем, но в какой-то момент прозрение дойдет до нас.",
	},
	{
		KEY_ACTOR : ACTOR_FRIEND,
	...
	{
		KEY_ACTOR : ACTOR_NONE,
		KEY_SPEECH : "Пожалуй, время начать все сначала и воспроизвести ту букву на осциллографе.",
	},
	{
	...
	{
		KEY_ACTOR : ACTOR_HERO,
		KEY_SPEECH : "Я тут поэкспериментировал с тем сигналом, что ты когда-то назвал шуткой…",
	},
	{
		KEY_ACTOR : ACTOR_FRIEND,
	...
	{
		KEY_ACTOR : ACTOR_FRIEND,
		KEY_SPEECH : "Или в дневниках сказано, зачем нужна фотография? Читай между строк.",
	},
	{
		KEY_ACTOR : ACTOR_HERO,
	...
	{
		KEY_ACTOR : ACTOR_NONE,
		KEY_SPEECH : "Стоп. Ведь с этой волны был и предыдущий шифр. Я не помню, был ли он такой же или нет.",
	},
	{
		KEY_ACTOR : ACTOR_NONE,
	...
	{
		KEY_ACTOR : ACTOR_HERO,
		KEY_SPEECH : "Так почему твоя ненависть к отцу переросла в веру, что он мне решил помочь?",
	},
	{
		KEY_ACTOR : ACTOR_FRIEND,
	...
	{
		KEY_ACTOR : ACTOR_FRIEND,
		KEY_SPEECH : "А как дело доходит до того, чтобы послушать чьи-то советы, так ты самый умный.",
	},
	{
		KEY_ACTOR : ACTOR_FRIEND,
	...
	{
		KEY_ACTOR : ACTOR_FRIEND,
		KEY_SPEECH : "Ну, к чему мы приблизились бы? Вот ты получил какую-то подсказку, а дальше что?",
	},
	{
		KEY_ACTOR : ACTOR_FRIEND,
	...
	{
		KEY_ACTOR : ACTOR_NONE,
		KEY_SPEECH : "Может быть, я его не так понял? Тогда почему он не объяснил, что имел в виду?",
	},
	{
		KEY_ACTOR : ACTOR_NONE,
	...
	{
		KEY_ACTOR : ACTOR_NONE,
		KEY_SPEECH : "Надо посмотреть, не разбилась ли фотография.",
	},
	{
		KEY_EVENTS : [event(self.cutscene_off)],
	},
	...
	{
		KEY_ACTOR : ACTOR_NONE,
		KEY_SPEECH : "Увидеть… Улучшить зрение… Очки! Точно!",
	},
	{
		KEY_ACTOR : ACTOR_NONE,
